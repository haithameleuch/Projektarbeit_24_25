...
namespace Manager
{
    ...
    public class InventoryManager : MonoBehaviour, IPointerClickHandler
    {
        ...
        /// <summary>
        /// Placeholder icons for each helmet slot.
        /// </summary>
        [SerializeField] private Sprite helmet;
        
        /// <summary>
        /// Placeholder icon for the body slot.
        /// </summary>
        [SerializeField] private Sprite body;
        
        /// <summary>
        /// Placeholder icon for the leg slot.
        /// </summary>
        [SerializeField] private Sprite legs;
        
        /// <summary>
        /// Placeholder icon for the boots slot.
        /// </summary>
        [SerializeField] private Sprite boots;
        
        /// <summary>
        /// Placeholder icon for the right-hand slot.
        /// </summary>
        [SerializeField] private Sprite rightHand;
        
        /// <summary>
        /// Placeholder icon for the left-hand slot.
        /// </summary>
        ...
        /// E = use item/equipment, O = remove item/equipment.
        /// </summary>
        private void Update()
        {
            if (!_isSetup) return;
        ...
        private void SetupUI()
        {
            ...
            {
                // Create a new row
                var row = Instantiate(rowPrefab, itemUI.transform);
            ...
            {
                // Create a new row
                var row = Instantiate(rowPrefab, equipUI.transform);
