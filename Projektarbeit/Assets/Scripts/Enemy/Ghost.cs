...
namespace Enemy
{
    public class Ghost : Agent
    {
        ...
        public override void Initialize()
        {
            ...
            // Freeze rotation on X and Z axes, and freeze Y position to keep agent grounded
        ...
        private IEnumerator FadeToAlpha(float targetAlpha)
        {
            ...
            // Ensure final alpha set exactly
            mat.color = new Color(color.r, color.g, color.b, targetAlpha);
        }

        /// <summary>
        /// Coroutine to smoothly move the ghost left or right over dashDuration seconds.
